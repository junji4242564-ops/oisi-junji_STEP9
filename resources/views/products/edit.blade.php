<x-app-layout>
    <div class="max-w-2xl mx-auto py-8 px-4">
        <h1 class="text-2xl font-bold mb-4">出品商品編集</h1>
        ...
        <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <x-text-input id="product_name" class="block mt-1 w-full" type="text" name="product_name" :value="old('product_name', $product->product_name)" required />
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="4" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">{{ old('description', $product->description) }}</textarea>
            ...
            <div class="mb-4">
                ...
                <img src="{{ asset('storage/' . $product->img_path) }}" alt="{{ $product->product_name }}" class="max-w-xs my-2">
            ...
            <div class="flex gap-4">
                <a href="{{ route('products.mine.show', $product->id) }}" class="bg-gray-300 px-4 py-2 rounded">戻る</a>
